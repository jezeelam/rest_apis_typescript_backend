...
describe('PUT /api/products/:id', () => {
    ...
    it('should return a 404 respose for a non-existent product', async () => {
        const productId = 2000
...
describe('PATCH /api/products/:id', () => {
    it('should return a 404 a response for a non-existing prduct', async () => {
        const productId = 2000
...
describe('DELETE /api/products/:id', () => {
    ...
    it('should return a 404 response for a non-existent prodcut', async () => {
        const productId = 2000
